...
import { parseWhatsAppChat, getUserWithMostMessages, getBusiestHour, getBusiestDay, getMostUsedEmoji, getHourlyActivityData, getMostUsedWords } from "../utils/parser";
import "./UploadSection.css"; 

ChartJS.register(CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend);

/* ── Iconos SVG inline ─────────────── */
const IconMessage = () => <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z" /></svg>;
...
const IconClock = () => <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm.5 5v5.25l4.5 2.67-.75 1.23L11 13V7h1.5z" /></svg>;
const IconChat = () => <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z" /></svg>;
...
export const UploadSection = () => {
  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      ...
      const dailyAverage = Math.round(parsedData.length / totalDays);
      ...
      setMetrics({
        ...
        // Guardamos las métricas extra en el estado
    ...
    return (
      <div className="landing-container">
        ...
        <nav className="landing-nav">
          <div className="logo-icon"><IconChat /></div>
          <h2>WhatsAnalyze <span style={{fontWeight: '400', fontSize: '16px'}}>| Equipo 10</span></h2>
        </nav>
        ...
        <div className="landing-content">
          <div className="landing-text">
            ...
            <p className="subtitle">
              Analizá tu historial de WhatsApp para descubrir patrones ocultos, horarios de mayor actividad, usuarios más frecuentes y el emoji favorito de tu grupo.
            </p>
            ...
            <ul className="features-list">
              <li>
                ...
                <div>
                  ...
                  <p>Tus datos no se envían a ningún servidor. Todo el análisis se realiza localmente en tu navegador.</p>
                </div>
              </li>
              <li>
                <span className="feature-icon">📊</span>
                <div>
                  ...
                  <p>Gráficos interactivos, nubes de palabras y métricas precisas por usuario y fecha.</p>
                </div>
              </li>
              <li>
                <span className="feature-icon">⚡</span>
                <div>
                  ...
                  <p>Solo exportá tu chat desde WhatsApp, subí el archivo .txt y mirá la magia en tiempo real.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="upload-box-container">
            <div className="upload-card">
              ...
              />
              <label htmlFor="chat-file" className="btn-primary upload-btn-large">
                Seleccionar archivo .txt
              </label>
              
              <span className="upload-note">Solo se aceptan archivos .txt exportados desde WhatsApp.</span>
            </div>
          </div>
        </div>
      </div>
  ...
  const topUserPct = metrics.topUser ? ((metrics.topUser.count / metrics.total) * 100).toFixed(1) : 0;
  const emojiPct = metrics.mostUsedEmoji ? ((metrics.mostUsedEmoji.count / metrics.total) * 100).toFixed(1) : 0;
  const hourPct = metrics.busiestHour ? ((metrics.busiestHour.messages / metrics.total) * 100).toFixed(1) : 0;
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom" style={{ marginTop: 'auto' }}>
          <div className="file-info-box">
            ...
            <input type="file" id="change-file" accept=".txt" onChange={handleFileUpload} style={{ display: "none" }} />
            <label htmlFor="change-file" className="btn-outline">Cambiar archivo</label>
          </div>
        </div>
      </aside>
      ...
      <main className="main-content">
        ...
        <div className="grid-row grid-4">
          <div className="card kpi-card">
            <div className="kpi-icon bg-green"><IconMessage /></div>
          ...
          <div className="card kpi-card">
            <div className="kpi-icon bg-blue"><IconUsers /></div>
            <div className="kpi-data">
          ...
          <div className="card kpi-card">
            <div className="kpi-icon bg-yellow"><IconClock /></div>
            <div className="kpi-data">
              <span className="label">Días en el rango</span>
              <span className="value">{fmt(metrics.totalDays)}</span>
              <span className="sub">{metrics.firstDate} - {metrics.lastDate}</span>
            </div>
          </div>
          <div className="card kpi-card">
            <div className="kpi-icon bg-purple"><IconChat /></div>
            <div className="kpi-data">
        ...
        <div className="grid-row grid-4">
          <div className="card highlight-card">
            ...
            <div className="hl-content">
              ...
              <div className="progress-bar-container">
                <div className="progress-bar" style={{ width: `${topUserPct}%` }}></div>
              </div>
          ...
          <div className="card highlight-card center-content">
            ...
            <div className="hl-content emoji-box">
              <span className="big-emoji">{metrics.mostUsedEmoji?.emoji || "—"}</span>
          ...
          <div className="card highlight-card">
            ...
            <div className="hl-content">
              <strong className="big-text">{metrics.busiestHour?.hour || "—"}</strong>
          ...
          <div className="card highlight-card">
            ...
            <ul className="top-days-list">
              ...
              {Array.from({ length: Math.max(0, 5 - (metrics.top5Days?.length || 0)) }).map((_, idx) => (
                <li key={`empty-${idx}`}>
              ...
              {arrangedWords.map((word, index) => {
                  ...
                  return (
                    <span key={index} style={{ 
                      ...
                      color: index % 3 === 0 ? '#128C7E' : (index % 2 === 0 ? '#25D366' : '#075E54'),
                      margin: '4px 10px',
                      lineHeight: '1.1',
